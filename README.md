...
The Author Quiz is a sample app which is developed using REACT. It's a simple game that displays the image of a famous author. The player has to select from a list the name of a book written by that author. For example there will be image displayed and list of options of books by authors give. If the player chooses an incorrect answer a red highlight is displayed. If the player chooses a correct answer a green highlight is displayed and the continue button appears. Clicking continue causes a fresh game to be loaded. 
...
- [Quiz application using REACT](#quiz-application-using-react)
